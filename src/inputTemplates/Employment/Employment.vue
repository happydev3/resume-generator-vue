<template>
  <TemplateContainer @delete="$emit('delete')">
    ...
    <template v-slot:body>
      ...
      <div class="row">
        <div class="col">
          <TextInput @change="emitVal" :date="true" type="month" format="MMM, YY" label="Start Date" v-model="value.startDate"></TextInput>
        </div>
        <div class="col">
          <TextInput @change="emitVal" :date="true" type="month" format="MMM, YY" label="End Date" v-model="value.endDate"></TextInput>
        </div>
      </div>
      <div class="row">
        <div class="col">
